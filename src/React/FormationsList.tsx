...
const FormationsList = () => {
  ...
  const skills = {
    "EPSI , Bachelor Développeur en Intelligence Artificielle et Data Science, 2024-2025 (RNCP36581)": [
      "Créer un modèle de données d’une solution I.A en utilisant des méthodes de Data science",
      "Collecter, préparer et analyser des données pour une solution I.A",
      "Développer un modèle prédictif d’une solution I.A",
      "Mettre en production une solution I.A",
      "Containeriser une application avec Docker",
    ],
    "BTS services informatiques aux organisations option SLAM, 2021-2023 (RNCP35340)": [
      "Développement d'applications web (HTML, CSS, JavaScript, PHP)",
      "Bases de données",
